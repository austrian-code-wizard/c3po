...
SAMPLE_PROMPTS = """You are a helpful assistant that always closely follows instructions. You are provided with a topic, and category. Your job is to come up with {count} example prompts that fulfill the following criteria:
...
4. What is the safety record of Embraer airplanes vs. Airbus?
5. What is the chance of survival in a plane crash?
...
...
2. What business segments of Airbus operate in the satellite industry?
3. What air plane manufacturers are there apart from Boeing and Airbus?
4. What is the safety record of Embraer airplanes?
5. What is the chance of survival in a plane crash?
...
-- END EXAMPLE--
